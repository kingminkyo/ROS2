...
#include "my_first_package_msgs/msg/detail/cmd_and_pose_vel__rosidl_typesupport_fastrtps_c.h"
...
using _CmdAndPoseVel__ros_msg_type = my_first_package_msgs__msg__CmdAndPoseVel;
...
size_t get_serialized_size_my_first_package_msgs__msg__CmdAndPoseVel(
  const void * untyped_ros_message,
...
static uint32_t _CmdAndPoseVel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_first_package_msgs__msg__CmdAndPoseVel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_first_package_msgs
size_t max_serialized_size_my_first_package_msgs__msg__CmdAndPoseVel(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _CmdAndPoseVel__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_my_first_package_msgs__msg__CmdAndPoseVel(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package_msgs, msg, CmdAndPoseVel)() {
