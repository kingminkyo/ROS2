...
#include "my_first_package_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CmdAndPoseVel_type_support_symbol_names_t _CmdAndPoseVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_first_package_msgs, msg, CmdAndPoseVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_first_package_msgs, msg, CmdAndPoseVel)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_my_first_package_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_first_package_msgs, msg, CmdAndPoseVel)() {
  return &::my_first_package_msgs::msg::rosidl_typesupport_c::CmdAndPoseVel_message_type_support_handle;
}
