...
#ifndef MY_FIRST_PACKAGE_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
#define MY_FIRST_PACKAGE_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__my_first_package_msgs__msg__CmdAndPoseVel __attribute__((deprecated))
#else
# define DEPRECATED__my_first_package_msgs__msg__CmdAndPoseVel __declspec(deprecated)
#endif
...
struct CmdAndPoseVel_
{
  ...
  // pointer types
  using RawPtr =
    my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_first_package_msgs__msg__CmdAndPoseVel
    std::shared_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_first_package_msgs__msg__CmdAndPoseVel
    std::shared_ptr<my_first_package_msgs::msg::CmdAndPoseVel_<ContainerAllocator> const>
...
using CmdAndPoseVel =
  my_first_package_msgs::msg::CmdAndPoseVel_<std::allocator<void>>;
...
#endif  // MY_FIRST_PACKAGE_MSGS__MSG__DETAIL__CMD_AND_POSE_VEL__STRUCT_HPP_
